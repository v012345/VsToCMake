		...
		namespace Systems {
			namespace Text {
				...
				public:
					...
					void CopyTo(int sourceIndex, intrusive_ptr<CString> destination, int destinationIndex, int count);
				...
				public:
					...
					intrusive_ptr<StringBuilder> Append(Char* value, Int32 startIndex, int count);
					intrusive_ptr<StringBuilder> Append(char value);
