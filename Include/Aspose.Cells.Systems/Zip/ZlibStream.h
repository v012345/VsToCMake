	...
	namespace Cells {
		namespace Zip {
			...
			public:
				...
				intrusive_ptr<Aspose::Cells::Zip::ZlibBaseStream> _baseStream;
				bool _disposed;
			private:
			...
			public:
				...
				ZlibStream(intrusive_ptr<Aspose::Cells::Systems::IO::Stream> stream, Aspose::Cells::Zip::CompressionMode mode);
				ZlibStream(intrusive_ptr<Aspose::Cells::Systems::IO::Stream> stream, Aspose::Cells::Zip::CompressionMode mode, Aspose::Cells::Zip::CompressionLevel level);
				ZlibStream(intrusive_ptr<Aspose::Cells::Systems::IO::Stream> stream, Aspose::Cells::Zip::CompressionMode mode, bool leaveOpen);
				ZlibStream(intrusive_ptr<Aspose::Cells::Systems::IO::Stream> stream, Aspose::Cells::Zip::CompressionMode mode, Aspose::Cells::Zip::CompressionLevel level, bool leaveOpen);
				virtual Aspose::Cells::Zip::FlushType GetFlushMode();
				virtual void SetFlushMode(Aspose::Cells::Zip::FlushType value);
