		...
		namespace Systems {
			namespace Collections {
				...
				public:
					...
					Hashtable(intrusive_ptr<Hashtable> d);
					Hashtable(intrusive_ptr<Hashtable> d,float f);
					Hashtable(intrusive_ptr<Hashtable> d, float f, IEqualityComparerPtr equalityComparer);
