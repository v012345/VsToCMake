		...
		namespace Systems {
			namespace Collections {
				...
				public:
					...
					ArrayList(intrusive_ptr<Aspose::Cells::Systems::Array1D<Aspose::Cells::Systems::Char>> values);
					ArrayList(intrusive_ptr<Aspose::Cells::Systems::Array1D<Aspose::Cells::Systems::Int32>> values);
					ArrayList(intrusive_ptr<Aspose::Cells::Systems::Array1D<Aspose::Cells::Systems::Int64>> values);
					ArrayList(intrusive_ptr<Aspose::Cells::Systems::Array1D<Aspose::Cells::Systems::Single>> values);
					ArrayList(intrusive_ptr<Aspose::Cells::Systems::Array1D<Aspose::Cells::Systems::Double>> values);
					virtual ~ArrayList();
					...
					virtual void AddRange(intrusive_ptr<Array1D<Object*>> array);
