	...
	namespace Cells {
		namespace Systems
		{
			...
			public:
				...
				static StringPtr StrCat(StringPtr v1, StringPtr v2, StringPtr v3, StringPtr v4, StringPtr v5, StringPtr v6, StringPtr v7, StringPtr v8, StringPtr v9, StringPtr v10, StringPtr v11, StringPtr v12, StringPtr v13, StringPtr v14,
					StringPtr v15, StringPtr v16, StringPtr v17, StringPtr v18, StringPtr v19, StringPtr v20, StringPtr v21);


			    static StringPtr Format(StringPtr format, ObjectPtr arg0);
				static StringPtr Format(StringPtr format, ObjectPtr arg0, ObjectPtr arg1);
			};
		}
	}
}  // namespace Systems
