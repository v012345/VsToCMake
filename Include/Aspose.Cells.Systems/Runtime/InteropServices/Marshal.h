...
namespace InteropServices {
	...
	public:
		...
		static void Copy(intrusive_ptr<Array1D<Int32>> source, Int32 startIndex, intrusive_ptr<Aspose::Cells::Systems::IntegerPtr> destination, Int32 length);
		...
		static void Copy(intrusive_ptr<Aspose::Cells::Systems::IntegerPtr> source, intrusive_ptr<Array1D<Int32>> destination, Int32 startIndex, Int32 length);
