	...
	namespace Cells {
		namespace Systems {
			...
			public:
				...
				int32_t GetHijriYear();
				int32_t GetHijriMonth();
				int64_t getInternalTicks();
				int32_t GetDaysInYear(int year);
				int32_t GetDatePart(int64_t ticks, int32_t part);
				bool    IsHijriLeapYear(int32_t year);
				int64_t DaysUpToHijriYear(int32_t HijriYear);
				int32_t GetHijriDayOfMonth();
